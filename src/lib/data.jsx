...
export const projects = [
  {
    projectId: '01',
    projectIcon: <SiOpenai className="card__techIcon" />,
  ...
  },
  {
    ...
    projectIcon: <SiThreads className="card__techIcon" />,
    projectType: 'Practice Project',
    projectRepo: 'https://github.com/Benjahh/benjahh.github.io',
  ...
  },
  {
    ...
    projectIcon: <SiSocialblade className="card__techIcon" />,
    projectType: 'Practice Project',
    projectRepo: 'https://github.com/Benjahh/benjahh.github.io',
    projectLink: 'https://google.com',
    projectDescription:
  ...
  },
  {
    ...
    projectIcon: <SiAppian className="card__techIcon" />,
    projectType: 'Practice Project',
    projectRepo: 'https://github.com/Benjahh/benjahh.github.io',
    projectLink: 'https://google.com',
    projectDescription:
